...
var MainScene = /** @class */ (function (_super) {
    ...
    function MainScene(param) {
        ...
        _this.loaded.add(function () {
            ...
            //スコア
            uiBase.append(new g.Sprite({ scene: _this, src: _this.assets["score"], x: 505, y: 5, height: 32 }));
            var score = 0;
            ...
            //何問目か
            uiBase.append(new g.Sprite({ scene: _this, src: _this.assets["score"], x: 430, y: 5, height: 32, srcY: 32 }));
            _this.labelStage = new g.Label({
                scene: _this,
                x: 360,
                y: 4,
                width: 32 * 2,
            ...
            uiBase.append(_this.labelStage);
            //レベル
            uiBase.append(new g.Sprite({ scene: _this, src: _this.assets["score"], x: 380, y: 40, height: 32, srcY: 64 }));
            _this.labelLevel = new g.Label({
                scene: _this,
                x: 455,
                y: 38,
                fontSize: 32,
            ...
            uiBase.append(_this.labelLevel);
            //タイム
            uiBase.append(new g.Sprite({ scene: _this, src: _this.assets["time"], x: 3, y: 10 }));
            var labelTime = new g.Label({ scene: _this, font: numFont, fontSize: 32, text: "70", x: 43, y: 13 });
            ...
            _this.append(fg);
            //リセットボタン
            var btnReset = new Button_1.Button(_this, ["リセット"], 500, 290, 130);
            if ((typeof window !== "undefined" && window.RPGAtsumaru) || isDebug) {
            ...
            //ランキングボタン
            var btnRanking = new Button_1.Button(_this, ["ランキング"], 500, 230, 130);
            if ((typeof window !== "undefined" && window.RPGAtsumaru) || isDebug) {
